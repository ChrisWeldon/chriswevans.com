    ...
    return (
      <div className="App">
        <div className="container center-block text-center">
          <div className="row navbar navbar-light fixed-top masthead justify-content-md-center">
            <div className="d-flex flex-column">
              <h1>Christopher W. Evans, 19</h1>
              <h4>Portland, ME</h4>
            </div>
          </div>
          <div class="row body">
            <div class="col-2 ">
              <div class="list-group sidenav faded-border">
                <button type="button" class="menu-item list-group-item list-group-item-action">About Me</button>
                <button type="button" class="menu-item list-group-item list-group-item-action">Projects</button>
                <button type="button" class="menu-item list-group-item list-group-item-action">Résumé</button>
              </div>
            </div>
